...
const ModalBillToReceivable = ({showModal, setShowModal}: Props) => {
    ...
    const {
      ...
      useEffect(() => {
        setValue('beneficiary_name', user.name.concat(' ', user.surname))
      }, [])
  ...
  return (
    <GenericModal title='Add bill to receivable' showModal={showModal} setShowModal={setShowModal}>
...
export default ModalBillToReceivable